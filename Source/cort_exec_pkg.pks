...
*/
  ...
  TYPE gt_rename_rec IS RECORD(
    ...
    object_name                  arrays.gt_name,  -- orginal object name
...
--    encrypt   for tablespaces only (NOT USED)
  ...
  TYPE gt_column_rec IS RECORD(
    ...
    cort_value                   VARCHAR2(32767), -- cort value
    cort_value_force             BOOLEAN,
  ...
  TYPE gt_partition_rec IS RECORD (
    table_owner                  arrays.gt_name,   -- Owner of the table
    ...
    comp_result                  PLS_INTEGER,      -- result of compare with peer partition
  ...
  TYPE gt_dependency_rec  IS RECORD(
    ...
    object_id                    NUMBER              -- object_id. NULL if object is in recyclebin
  );
  ...
  TYPE gt_type_rec        IS RECORD(
    ...
    attribute_arr                gt_type_attr_arr,       -- Array of attributes in the type
    attribute_ind_arr            arrays.gt_int_indx,     -- Index of attributes
    ...
    dependency_arr               gt_dependency_arr,      -- Type dependencies
    table_dependency             BOOLEAN,
    subtype_dependency           BOOLEAN,
--    sql_text                     CLOB,
    rename_rec                   gt_rename_rec,      -- record holding names for renaming
    privilege_arr                gt_privilege_arr    -- array of table privileges
  );
  ...
  -- record for holding current process params
